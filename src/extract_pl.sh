...
###
#era5_z500_natl_daily_1940-2022_2deg.nc:
#File in netcdf format from ERA5 daily rescans, resolution 2deg
#The data are daily values of geopotential height at 500hPa (variable z, unit: mgp) over the North Atlantic and for the period 1940-2022.

#era5_msl_natl_daily_1940-2022_2deg.nc:
#File in netcdf format from ERA5 daily rescans, resolution 2deg
#The data are daily values of reduced pressure at sea level (variable msl, unit: Pa) over the North Atlantic and for the period 1940-2022.
##
